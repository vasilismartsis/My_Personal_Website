    ...
    <header class="masthead">
        <div class="container px-4 px-lg-5 d-flex h-100 align-items-center justify-content-center">
            <?php
                ...
                $externalSite = $_GET["externalSite"];

                if($externalSite == null)
                    echo '<iframe style="height: 80vh; width: 140vh; margin-top:3rem;" src="projectTypes/'.$projectType.'/projects/'.$projectName.'/project/index.php"></iframe>';
                else
                    header( "Location: $externalSite" );
            ?>
        </div>
    </header>
    <!-- Contact-->
